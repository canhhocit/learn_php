    ...
    <form id="regForm" action="" method="post" novalidate>
      ...
      <div class="row">
        <div class="col">
          ...
          <input type="password" id="password" name="password" placeholder="Tối thiểu 6 ký tự" minlength="6"
            required />
        </div>
        <div class="col">
          <label for="confirm_password">Xác nhận mật khẩu</label>
          <input type="password" id="confirm_password" name="confirm_password" placeholder="Gõ lại mật khẩu"
            required />
        </div>
      </div>
